// =============================================================================
// SITEMAP DATA - INSTALACIÓN AEROTERMIA
// =============================================================================
// Instalación de sistemas de aerotermia en España - 8118 municipios
...
// =============================================================================
// HIGH-INTENT KEYWORD MODIFIERS - Sector Aerotermia
// =============================================================================
export const MODIFIERS = [
  "",
  // ============ PRECIO / PRESUPUESTO ============
  "-precios", "-barata", "-economica", "-cuanto-cuesta",
  "-presupuesto", "-presupuesto-online", "-financiacion",
  "-subvencion", "-ayudas",

  // ============ URGENCIA / VELOCIDAD ============
  "-urgente", "-rapida", "-instalacion-inmediata",

  // ============ CALIDAD / REPUTACION ============
  "-mejor", "-calidad-precio", "-profesional", "-de-confianza",
  "-mejor-valorada", "-recomendada", "-certificada",

  // ============ TIPO DE INSTALACION ============
  "-llave-en-mano", "-completa", "-integral",
  "-sustituir-caldera", "-cambiar-gas",

  // ============ MARCAS ============
  "-daikin", "-mitsubishi", "-vaillant", "-saunier-duval",
  "-panasonic", "-samsung", "-lg", "-toshiba",

  // ============ POTENCIA ============
  "-6kw", "-8kw", "-10kw", "-12kw", "-14kw", "-16kw",

  // ============ TIPO VIVIENDA ============
  "-chalet", "-adosado", "-piso", "-unifamiliar",
  "-obra-nueva", "-rehabilitacion",

  // ============ EFICIENCIA ============
  "-alta-eficiencia", "-cop-alto", "-clase-a",
  "-bajo-consumo", "-ahorro-energia",

  // ============ UBICACIÓN ============
  "-cerca-de-mi", "-zona",

  // ============ COMBOS ============
  "-con-suelo-radiante", "-con-radiadores", "-con-fancoils",
  "-hibrida-gas", "-solo-calefaccion", "-frio-calor",
] as const;
...
export const PROBLEMS: Record<Service, readonly string[]> = {
  "aerotermia": [
    "factura-gas-alta", "caldera-vieja", "quiero-dejar-gas",
    "calefaccion-ineficiente", "quiero-energia-renovable",
    "subvenciones-aerotermia",
  ],
  "bomba-calor": [
    "sustituir-caldera-gas", "bomba-calor-aire-agua",
    "bomba-calor-monobloc", "bomba-calor-bibloc",
    "bomba-calor-inverter",
  ],
  "aerotermia-radiadores": [
    "radiadores-baja-temperatura", "adaptar-radiadores",
    "aerotermia-radiadores-existentes", "cambiar-caldera-por-aerotermia",
  ],
  "aerotermia-suelo-radiante": [
    "instalar-suelo-radiante", "suelo-radiante-refrescante",
    "aerotermia-obra-nueva", "suelo-radiante-aerotermia",
  ],
  "aerotermia-acs": [
    "agua-caliente-sanitaria", "termo-electrico-caro",
    "acs-eficiente", "agua-caliente-aerotermia",
  ],
  "aerotermia-piscina": [
    "calentar-piscina", "bomba-calor-piscina",
    "climatizar-piscina", "alargar-temporada-piscina",
  ],
  "instalacion-aerotermia": [
    "instalar-aerotermia", "proyecto-aerotermia",
    "instalador-certificado", "instalacion-profesional",
  ],
  "mantenimiento-aerotermia": [
    "revision-aerotermia", "mantenimiento-bomba-calor",
    "limpieza-aerotermia", "reparacion-aerotermia",
  ],
  "aerotermia-vivienda-unifamiliar": [
    "aerotermia-chalet", "aerotermia-casa-grande",
    "aerotermia-200m2", "aerotermia-300m2",
  ],
  "aerotermia-piso": [
    "aerotermia-apartamento", "aerotermia-comunidad",
    "aerotermia-edificio", "aerotermia-piso-pequeno",
  ],
} as const;
